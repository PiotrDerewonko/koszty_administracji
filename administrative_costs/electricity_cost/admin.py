...
class EnergyMetersAdmin(admin.ModelAdmin):
    list_display = ['name', 'technical_name', 'meter_location', 'museum_share', 'cob_share', 'parish_share',
                    'institute_share', 'conversion_factor', 'is_virtual', 'is_add_manual', 'initial_value']
